        ...
        >
            ...
            >
                ...
                <div className="flex flex-col gap-4">
                    <div>
                        {/* UserPost: name 대신 username */}
                        <h2 className="text-2xl font-bold">{profile.username}</h2> 
                        {/* UserPost: role 대신 workStyle */}
                        <p className="text-slate-600">{profile.workStyle}</p> 
                    </div>
                    <hr />
                    <div className="text-sm space-y-2">
                        {/* UserPost: location, university 필드 제거 */}
                        
                        {/* UserPost: note 대신 intro */}
                        <p><strong> 소개:</strong> {profile.intro}</p> 
                        
                        {/* UserPost: contactType, contactValue, collaborationPeriod 추가 */}
                        <p><strong> 협업 기간:</strong> {profile.collaborationPeriod}</p>
                        <p><strong> 연락 수단:</strong> {profile.contactType} ({profile.contactValue})</p>
                    </div>
