  ...
  useEffect(() => {
    const loadUser = async () => {
      try {
        ...
        setWorkStyle(user.workStyle || "");
        setCollaborationPeriod(user.collaborationPeriod || "");
        setContactType(user.contactType || "email");
    ...
    <section className="scroll-mt-[72px]">
      <div className="container max-w-[1280px] mx-auto px-4 py-8 sm:py-10">
        ...
        <div className="mb-6 flex items-center justify-between">
          <h1 className="text-2xl font-bold tracking-tight sm:text-3xl">프로필 수정</h1>
          <button
            type="button"
